package com.david_422017001.d_cinema_21.home.setting
...
import com.david_422017001.d_cinema_21.MyWalletActivity
...
class SettingFragment : Fragment() {
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        tv_my_wallet.setOnClickListener {
            var wallet = Intent(context, MyWalletActivity::class.java)
        ...
        tv_logout.setOnClickListener{
            ...
            var logout = Intent(context, SignInActivity::class.java)
